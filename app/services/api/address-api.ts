...
export class AddressApi {
     ...
     */
    async getProvince(filter: any): Promise<any> {
        // make the api call
        ...
        try {
            ...
            console.log("Error call api province : ", error)
            return error
        }
    }
    async getRegion(filter: any): Promise<any> {
        // make the api call
        // console.log("Filter truck type  :: ", filter)
        try {
            ...
            console.log("Error call api get region : ", error)
            return error
        }
    }
