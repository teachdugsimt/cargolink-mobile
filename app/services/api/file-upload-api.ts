...
export class FileUploadApi {
  ...
  async uploadVehiclePicture(params: any): Promise<any> {
    // make the api call
    try {
      __DEV__ && console.tron.log("Comming to upload API :: ", params)
      ...
      //     headers: {
      //       "Content-Type": 'multipart/form-data',
      //       "Authorization": "Bearer eyJhbGciOiJIUzUxMiJ9..L5rakcUY-7TViXxsbTUKKIvXQ9Q6w7gufJWFUUtpsQrOkvDill-U-klLiEci6cGnuDM4BaAYD_VTpitKKHqZCQ"
      //     },
      //   }
      // ).then(val => console.log("Value file upload fetch : ", val))
      //   .catch(err => console.log("Error Fetching upload image : ", err))
