...
export const JobDetailOnlyScreen = observer(function JobDetailScreen() {
  ...
  useEffect(() => {
    if(jobID) CarriersJobStore.findOne(jobID)
    if(quotationsID) CarriersJobStore.getJobDetail(quotationsID)
