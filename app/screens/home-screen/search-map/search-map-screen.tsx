...
export const LocationPickerScreen = observer(function LocationPickerScreen(props: SearchMapProps) {
  ...
  const { banner, onSubmitMap }: SearchMapProps = route?.params || {}
  ...
  const onRegionChange = (regionParam) => {
    console.log("__________ On Region Change __________:",regionParam?.currentTarget)
